...
import rolette from '../assets/slotmachine.png';
                   ...
                   <div className='pt-9'>
                       ...
                       <div className='pt-7'>
                           ...
                           <p className='text-[#E5E5E5] text-sm px-5 text-justify pb-12'>
                            Slots are all about simplicity and excitement! Spin the reels and match symbols across paylines to win. Wilds and scatters trigger bonuses like free spins or multipliers. No strategy needed—just press "Spin" and hope for a jackpot! High volatility slots offer bigger (but rarer) payouts.
                           </p>
