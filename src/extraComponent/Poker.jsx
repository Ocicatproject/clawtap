...
import rolette from '../assets/poker.png';
                    ...
                    <div className='pt-9'>
                        ...
                        <div className='pt-7'>
                            ...
                            <p className='text-[#E5E5E5] text-sm px-5 text-justify pb-12'>
                             Each player gets two cards, and five community cards are dealt face-up. Bet, fold, or raise based on your hand strength. The best five-card combination wins! Bluffing and reading opponents are key. Royal flushes beat all—master the rankings to dominate the table.
                            </p>
