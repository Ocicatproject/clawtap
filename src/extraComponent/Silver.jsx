...
const MAX_POINTS = 1000000000; // 1B
const MIN_DAYS_PER_LEVEL = 40; // 40 din wait for next level
...
const Silver = () => {
    ...
    return (
        <div className="relative w-full min-h-screen flex justify-center bg-cover bg-center">
            ...
            >
                <h2 className="text-white text-[24px] font-bold mb-8 pt-14">Silver</h2>

                <div className="flex justify-center mb-10 relative">
                    <img src={silver} alt="Silver Trophy" className=" relative z-10" />
                    <img src={silverstar} alt="Silver Star" className=" absolute -top-16" />
                ...
                <div className="mt-6 space-y-3 pb-5 mx-auto">
                    <div className="bg-[#281A90] text-white mx-4 text-sm text-left font-semibold py-3 px-4 rounded-lg">
                        Pro Tip: <span className='font-[300]'>Limit is 100,000,000 points per day</span>
                    </div>
                    <div className="bg-[#281A90] text-white mx-4 text-sm text-left py-3 px-4 rounded-lg space-y-1">
                        ...
                        <p className='font-[300]'>• Can use treasury 20 50 120 250 500</p>
